# PoC Reverse Proxy MITM-PROXY script to rewrite all response|status codes to 404 Not Found
#
...
def response(context, flow):
    ...
    if(flow.response.code >= 301 and flow.response.code <= 303):
        ...
        # Redirects need to be followed and won't work if response code is 500
        if debug:
